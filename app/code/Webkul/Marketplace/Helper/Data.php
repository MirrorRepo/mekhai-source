...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $targetUrl = $this->getWkTargetUrlPath();
        if ($targetUrl) {
    ...
    public function getWkCollectionUrl()
    {
        $targetUrl = $this->getWkTargetUrlPath();
        if ($targetUrl) {
            $temp = explode('/collection/shop', $targetUrl);
    ...
    public function getWkTargetUrlPath()
    {
        $urls = explode(
    ...
    {
        $collection = $this->getSellerProductCollection($sellerId);
        return $collection->getSize();
    }

    public function getSellerProductCollection($sellerId)
    {
        ...
        $helper->addInStockFilterToCollection($collection);
