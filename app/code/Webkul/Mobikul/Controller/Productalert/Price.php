<?php
    ...
    */
    ...
    class Price extends \Webkul\Mobikul\Controller\ApiController    {
            ...
            try {
                ...
                if ($wholeData) {
                    ...
                    if ($authData["responseCode"] == 1 || $authData["responseCode"] == 2) {
                        ...
                        $websiteId   = $this->_objectManager->create("\Magento\Store\Model\StoreManagerInterface")->getStore()->getWebsiteId();
