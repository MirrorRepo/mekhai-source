<?php
    ...
    */
    ...
    class Save extends \Webkul\Mobikul\Controller\Adminhtml\Featuredcategories  {

        public function execute()       {
            $returnToEdit         = false;
            $originalRequestData  = $this->getRequest()->getPostValue();
            $featuredcategoriesId = isset($originalRequestData["mobikul_featuredcategories"]["id"]) ? $originalRequestData["mobikul_featuredcategories"]["id"] : null;
...
// Done Saving featuredcategories, finish save action ///////////////////////////////////////////////////////////////////////////
                    ...
                    $this->messageManager->addException($exception, __("Something went wrong while saving the featuredcategories. %1",$exception->getMessage()));
                    $this->_getSession()->setFeaturedcategoriesFormData($originalRequestData);
                    $returnToEdit = true;
                }
            }
            ...
            if ($returnToEdit) {
                if ($featuredcategoriesId)
                    $resultRedirect->setPath("mobikul/featuredcategories/edit", ["id"=>$featuredcategoriesId, "_current"=>true]);
                else
