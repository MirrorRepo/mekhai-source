<?php
    ...
    */
    ...
    class Upload extends \Webkul\Mobikul\Controller\Adminhtml\Categoryimages    {
        ...
        public function execute()   {
            ...
            if ($this->getRequest()->isPost()) {
                try {
                    ...
                    try {
                        $uploader = $this->_fileUploaderFactory->create(["fileId"=>"mobikul_categoryimages[filename]"]);
