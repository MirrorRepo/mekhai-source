<?php
namespace Magento\Store\Model\App\Emulation;

/**
 * Proxy class for @see \Magento\Store\Model\App\Emulation
 */
class Proxy extends \Magento\Store\Model\App\Emulation implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Store\\Model\\App\\Emulation', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->startEnvironmentEmulation($storeId, $area, $force);
    }
    ...
    {
        return $this->_getSubject()->stopEnvironmentEmulation();
    }
    ...
    {
        return $this->_getSubject()->storeCurrentEnvironmentInfo();
    }
