...
/**
 * Proxy class for @see \Magento\Directory\Model\Country
 */
class Proxy extends \Magento\Directory\Model\Country implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Directory\\Model\\Country', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->loadByCode($code);
    }
    ...
    {
        return $this->_getSubject()->getLoadedRegionCollection();
    }
    ...
    {
        return $this->_getSubject()->formatAddress($address, $html);
    }
    ...
    {
        return $this->_getSubject()->getFormat($type);
    }
    ...
    {
        return $this->_getSubject()->getName($locale);
    }
